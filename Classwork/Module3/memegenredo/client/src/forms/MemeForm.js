    ...
    return(
        <form className='grid grid-cols-1 col-start-1 col-end-2'>
            <div className='grid max-h-auto grid-cols-4'>
                <input className='col-span-4 focus:ring-2 text-xs focus:ring-gray-200' type='text' name='topText' placeholder='First text' value={inputs.topText} onChange={handleChange} required/>
                <input className='col-span-4 focus:ring-2 text-xs focus:ring-gray-200' type='text' name='bottomText' placeholder='Second text' value={inputs.bottomText} onChange={handleChange} required/>
